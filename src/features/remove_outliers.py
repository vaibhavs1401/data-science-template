...
for col in outlier_columns:
    for label in df["label"].unique():
        # Mark outliers for the specific label and column
        dataset = mark_outliers_chauvenet(df[df["label"] == label], col)
        
        # Set outliers to NaN in the dataset
...
# --------------------------------------------------------------
outliers_remove_df.to_pickle("../../data/interim/01_outliers_removed_chauvenets.pkl")