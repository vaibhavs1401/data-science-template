...
acc_r = df_squared["acc_x"] **2 + df_squared["acc_y"] **2 + df_squared["acc_x"] ** 2
gyr_r = df_squared["gyr_x"] **2 + df_squared["gyr_y"] **2 + df_squared["gyr_x"] ** 2
...
# Countering data spill in other set
df_temporal_list = []
...
for s in df_freq["set"].unique():
    print(f"Applying Fourier Trasnformations to set {s}")
